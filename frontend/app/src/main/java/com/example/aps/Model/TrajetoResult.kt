...
fun TrajetoResult(trajetoResponse: TrajetoResponse?, textSizeFactor: Float) {
    if (trajetoResponse != null) {
        Column(
            // ✅ OK: fillMaxWidth() garante que o Column se ajuste corretamente ao LazyColumn pai.
            modifier = Modifier
                .fillMaxWidth()
                .padding(top = 8.dp),
            ...
            // ✅ OK: Column com forEachIndexed evita conflito de rolagem.
            Column(
                modifier = Modifier.fillMaxWidth()
            ) {
                trajetoResponse.caminho.forEachIndexed { index, etapa ->
...
// -----------------------------------------------------
// --- COMPONENTES DE ESTATÍSTICAS (MANTIDO) ---
// -----------------------------------------------------
...
fun EstatisticasCard(trajetoResponse: TrajetoResponse, textSizeFactor: Float) {
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            // ✅ Exibição do Score de Ranking da Linha
